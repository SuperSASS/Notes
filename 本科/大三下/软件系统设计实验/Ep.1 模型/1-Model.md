...
使用时序图来**阐明用例的实现**，即说明对象如何**通过交互**来执行**全部或部分用例**的行为，  
...
![图 3](images/1-Model--04-21_15-32-40.png)  
